...
arrx=np.array([25,27,27,26,27,25,23,25,22,26,
               25,21,24,22,24,24,23,22,29,26,
               21,26,23,24,24,20,29,22,23,18,
               27])
n=len(arrx)

arry=np.array([21,19,19,22,25,20,25,23,26,27,
               22,25,27,20,19,23,28,22,25,23,
               28])
m=len(arry)
...
print('1 Test bilaterale di Fisher(no varianza) di livello alfa per varianza')
Fo=varcx/varcy
...
print('------------------------------------------')
print('')
print('2 Test unilaterale di Fisher(no varianza) di livello alfa per attesa')
