...
arrl=np.array([1.70,1.93,2.42,2.52,2.59,2.66,2.72,2.76,2.88,3.01,
               ...
               5.66,5.83,6.90])
rang=np.array([0,2,3,3.5,4,4.5,5,6,8])
...
mediana=((tot+1)/2)
print('Quantile mediana dispari:      {}\t'.format(arrl[int(mediana)]))
"""flag=0
for i in range(0, len(Fk)):
    if mediana<= Fk[i]:
        mediana=k[i]
