...
print('pk  {:1.2f} {:1.2f} {:1.2f} {:1.2f} {:1.2f}  {:1.2f}  {:1.2f} {:1.2f} {:1.2f} {:1.2f}  {:1.2f}  {:1.2f} {:1.2f} {:1.2f}\t'.format(*pk))

fk=copy.copy(Fk)
for i in range(0, len(Fk)):
    fk[i]= fk[i]/ Fk[len(freq)-1]
print('fk  {:1.2f} {:1.2f} {:1.2f} {:1.2f} {:1.2f}  {:1.2f}  {:1.2f} {:1.2f}  {:1.2f} {:1.2f} {:1.2f}  {:1.2f}  {:1.2f} {:1.2f}\t\n'.format(*fk))
